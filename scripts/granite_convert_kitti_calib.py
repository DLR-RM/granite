...
parser = argparse.ArgumentParser(description='Convert KITTI calibration to granite and save it int the dataset folder as granite_calib.json.')
...
with open(kitti_calib_file, 'r') as stream:
    ...
    with open(dataset_path + '/granite_calib.json', 'w') as stream2:
        stream2.write(calib)